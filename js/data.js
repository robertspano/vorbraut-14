...
const APARTMENTS = [
  ...
  // ---- 2. hæð — svalir ----
  { id: '0201', floor: 2, area: 128.8, rooms: 4, beds: 3, type: 'fam', outdoor: 'svalir', balcony: 8.1, status: 'available', price: 119900000, plan: '0201.png', planExact: true , parking: 1 },
  ...
  // ---- 3. hæð — svalir ----
  { id: '0301', floor: 3, area: 130.3, rooms: 4, beds: 3, type: 'fam', outdoor: 'svalir', balcony: 8.1, status: 'sold', plan: '0301.png', planExact: true , parking: 1 },
...
const FACADE = {
  ...
  zones: {
    '0101': [[795,598],[797,566],[993,566],[992,588],[1020,629],[1019,645],[1025,656],[1025,668],[859,666],[853,654],[804,654],[805,627]],
    '0102': [[612,559],[718,559],[719,565],[797,566],[795,598],[805,627],[804,654],[745,654],[746,666],[625,666],[612,666],[612,621]],
    '0103': [[507,560],[612,559],[612,621],[612,666],[479,666],[479,652],[420,652],[418,625],[425,597],[423,564],[506,564]],
    '0104': [[272,564],[423,564],[425,597],[418,625],[420,652],[362,650],[355,664],[203,664],[203,654],[208,643],[206,628],[238,584],[237,564],[265,564]],
    '0201': [[805,486],[1006,486],[1005,506],[1023,528],[1020,566],[802,566]],
    '0202': [[612,482],[720,482],[722,486],[805,486],[802,566],[719,565],[718,559],[612,559]],
    '0203': [[421,485],[504,485],[505,478],[611,478],[612,559],[507,560],[506,564],[423,564]],
    '0204': [[250,484],[421,482],[423,564],[205,564],[202,526],[219,505],[218,485]],
    '0301': [[807,391],[992,392],[1014,392],[1014,398],[1012,429],[1031,448],[1027,486],[805,486]],
    '0302': [[612,391],[807,391],[805,486],[722,486],[720,482],[612,482]],
    '0303': [[439,391],[612,391],[611,478],[505,478],[504,485],[421,485],[420,446],[418,391],[439,391]],
    '0304': [[242,391],[418,391],[421,482],[197,485],[195,446],[212,428],[210,392],[210,392]],
    '0401': [[612,271],[716,271],[711,257],[779,257],[816,257],[817,230],[823,230],[823,257],[1010,258],[1009,282],[993,282],[992,316],[1019,336],[1018,368],[1023,368],[1021,384],[1009,384],[1009,392],[922,391],[612,391]],
    '0402': [[214,256],[379,256],[402,256],[402,228],[409,228],[410,256],[442,256],[514,256],[509,271],[612,271],[612,391],[333,390],[218,388],[205,387],[204,365],[208,363],[207,333],[234,333],[234,322],[232,280],[216,280]],
  }
};
...
FACADE.zonesFraman = {
    '0101': [[341,498],[547,499],[549,562],[460,561],[459,553],[346,552]],
    '0102': [[547,499],[629,499],[629,546],[553,546],[549,562]],
    '0103': [[629,499],[711,499],[710,554],[708,546],[629,546]],
    '0104': [[804,500],[923,502],[918,558],[801,554]],
    '0201': [[334,442],[544,442],[547,499],[341,498]],
    '0202': [[544,442],[629,443],[629,499],[547,499]],
    '0203': [[629,443],[712,442],[711,499],[629,499]],
    '0204': [[712,442],[929,443],[923,502],[711,499]],
    '0301': [[327,382],[449,382],[448,386],[542,386],[544,442],[334,442]],
    '0302': [[542,386],[628,386],[629,443],[544,442]],
    '0303': [[628,386],[713,386],[712,442],[629,443]],
    '0304': [[810,382],[934,383],[929,443],[712,442],[713,386],[812,387]],
    '0401': [[318,307],[446,307],[454,294],[534,294],[542,294],[546,377],[542,386],[448,386],[449,382],[327,382]],
    '0402': [[712,302],[720,302],[719,296],[806,296],[813,309],[942,308],[936,383],[810,382],[812,387],[713,386],[712,376]],
};
...
const KJALLARI = {
  ...
  w: 1506, h: 840,
  /* Öll tíu stæðin — þríhyrningsmerki er teiknað í hvert þeirra. */
  staediReitir: {
    'B01': [446, 33, 583, 235],
    'B02': [593, 33, 697, 235],
    'B03': [1139, 34, 1276, 239],
    'B04': [1286, 34, 1401, 239],
    'B05': [594, 504, 711, 682],
    'B06': [723, 502, 856, 682],
    'B07': [867, 502, 1000, 682],
    'B08': [1011, 502, 1128, 682],
    'B09': [1139, 501, 1276, 682],
    'B10': [1286, 501, 1401, 681],
  },
  ibudir: {
    '0101': { staedi: ['B10'], geymsla: [1286, 692, 1400, 816] },
    '0102': { staedi: [], geymsla: [478, 754, 582, 816] },
    '0103': { staedi: [], geymsla: [478, 687, 582, 747] },
    '0104': { staedi: ['B09'], geymsla: [1138, 692, 1275, 816] },
    '0201': { staedi: ['B08'], geymsla: [1011, 692, 1128, 816] },
    '0202': { staedi: [], geymsla: [478, 618, 584, 679] },
    '0203': { staedi: [], geymsla: [477, 551, 582, 612] },
    '0204': { staedi: ['B07'], geymsla: [867, 692, 1000, 816] },
    '0301': { staedi: ['B06'], geymsla: [722, 693, 856, 816] },
    '0302': { staedi: [], geymsla: [709, 163, 805, 212] },
    '0303': { staedi: [], geymsla: [928, 141, 1025, 212] },
    '0304': { staedi: ['B05'], geymsla: [594, 692, 711, 816] },
    '0401': { staedi: ['B03', 'B04'], geymsla: [1033, 34, 1129, 212] },
    '0402': { staedi: ['B01', 'B02'], geymsla: [321, 33, 435, 154] },
  },
};
...
const VIEWS = [
  ...
  { id: 'framan',   label: 'Framhlið',     img: 'assets/renders/foto-fram-2.webp', zones: 'framan' },
