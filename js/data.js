...
const APARTMENTS = [
  ...
  { id: '0101', floor: 1, area: 115.0, rooms: 4, type: 'fam',   outdoor: 'verond', status: 'available', plan: '0101.png', planExact: true  },
  { id: '0102', floor: 1, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'verond', status: 'available', plan: '0102.png', planExact: true  },
  { id: '0103', floor: 1, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'verond', status: 'available', plan: '0103.png', planExact: true  },
  { id: '0104', floor: 1, area: 102.2, rooms: 3, type: 'fam',   outdoor: 'verond', status: 'available', plan: '0104.png', planExact: true  },
  // ---- 2. hæð — svalir ----
  { id: '0201', floor: 2, area: 117.1, rooms: 4, type: 'fam',   outdoor: 'svalir', balcony: 8.1, status: 'available', plan: '0201.png', planExact: true  },
  { id: '0202', floor: 2, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'svalir', balcony: 5.9, status: 'available', plan: '0202.png', planExact: true  },
  { id: '0203', floor: 2, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'svalir', balcony: 5.9, status: 'available', plan: '0203.png', planExact: true  },
  { id: '0204', floor: 2, area: 118.4, rooms: 4, type: 'fam',   outdoor: 'svalir', balcony: 8.1, status: 'available', plan: '0204.png', planExact: true  },
  // ---- 3. hæð — svalir ----
  { id: '0301', floor: 3, area: 117.1, rooms: 4, type: 'fam',   outdoor: 'svalir', balcony: 8.1, status: 'available', plan: '0301.png', planExact: true  },
  { id: '0302', floor: 3, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'svalir', balcony: 5.9, status: 'available', plan: '0302.png', planExact: true  },
  { id: '0303', floor: 3, area: 64.5,  rooms: 2, type: 'two',   outdoor: 'svalir', balcony: 5.9, status: 'available', plan: '0303.png', planExact: true  },
  { id: '0304', floor: 3, area: 118.4, rooms: 4, type: 'fam',   outdoor: 'svalir', balcony: 8.1, status: 'available', plan: '0304.png', planExact: true  },
  // ---- 4. hæð (efsta hæð) — þaksvalir, aukin lofthæð ----
  // 0401 = vinstri þakíbúð, 0402 = hægri (skv. þinni númeringu). Grunnmynd + stærð víxlað til
  // samræmis við hæðarkort/framhlið; arkitektaskrárnar voru merktar öfugt (0401.png = hægri íbúðin).
  { id: '0401', floor: 4, area: 155.7, rooms: 4, type: 'pent',  outdoor: 'thaksvalir', ceiling: '3,45–3,70', status: 'available', plan: '0402.png', planExact: true, tex: '0401.png', walk3d: true  },
  { id: '0402', floor: 4, area: 157.6, rooms: 4, type: 'pent',  outdoor: 'thaksvalir', ceiling: '3,45–3,70', status: 'available', plan: '0401.png', planExact: true, walk3d: true  },
];
